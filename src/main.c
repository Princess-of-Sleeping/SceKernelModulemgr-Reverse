...
SceModuleObject *func_0x81001f0c(SceUID modid){
...
// 0x81007a84
int get_module_info_internal_by_addr(SceKernelProcessModuleInfo *pProcModuleInfo, const void *module_addr, SceModuleInfoInternal **dst){
